...
from .models import (
    Program, ProgramType, HomePage, Navbar, Logo, AdmissionSidebarItem, UndergraduateAddmissionReqPage, LanguageReqExemptionBullet, GraduateAdmissionPage,
    AdmissionReqBullet, OnlineCoursesBullet, OnlineCoursesPage, FundingPage, 
    ContactPage, Faculty, Department,DepartmentPage
)
