...
class ProgramType(models.Model):
    name = models.CharField(max_length=50, unique=True)  # e.g., Undergraduate, Graduate, Online
...
class Program(models.Model):
    ...
    # Optional fields
    routes = models.CharField(max_length=100, blank=True, null=True)  # e.g., Course-based
    enrollment_status = models.CharField(max_length=100, blank=True, null=True)  # e.g., Full-time
