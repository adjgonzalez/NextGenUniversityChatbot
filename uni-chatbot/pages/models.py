...
class UndergraduateAddmissionReqPage(models.Model):
    ...
    language_req_exemtion_desc = models.TextField(
        blank=True, null=True, help_text="Optional text after the bullet list"
    )
...
class OnlineCoursesBullet(models.Model):
    page = models.ForeignKey(
        OnlineCoursesPage, on_delete=models.CASCADE, related_name="online_bullets"
    )
    text = models.CharField(max_length=500)
...
class ContactPage(models.Model):
    ...
    office_location = models.CharField(
        max_length=255, default="NextGen University, St. John's, Canada"
    )
...
class DepartmentPage(models.Model):
    ...
    department = models.ForeignKey(
        "Department", related_name="pages", on_delete=models.CASCADE
    )
