    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('page_title', models.CharField(default='Online Courses', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('page', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='online_bullets', to='pages.onlinecoursespage')),
            ],
        ),
    ]
